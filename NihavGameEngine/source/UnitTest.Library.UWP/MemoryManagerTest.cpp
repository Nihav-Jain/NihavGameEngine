...
namespace UnitTestLibraryDesktop
{
	...
	TEST_CLASS(UWPMemoryManagerTest)
	{
	public:
		...
		TEST_METHOD(UWP_HeapManagerTest)
		{
			std::uint32_t id = 3;
		...
		TEST_METHOD(UWP_MemManagementDtorTest)
		{
...
#endif
		static UWPMemory memory;
	};

#if defined(DEBUG) | defined(_DEBUG)
	_CrtMemState UWPMemoryManagerTest::sStartMemState;
#endif
	UWPMemory UWPMemoryManagerTest::memory;
}